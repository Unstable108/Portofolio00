        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Talk-2-U"
              description="Personal Chat Room or Workspace to hangout with friends build with react.js, express.js, Node.js, Material-UI, and MongoDB. Have features which allows user for realtime messaging."
              ghLink="https://github.com/Unstable108/Talk-2-U"
